...
def run_streamlit_app():
    ...
    st.info("✅ **v2.4.0 Features**: Improved platform detection using 'Funnel Stage' markers • Support for all 8 platforms (YouTube, META, TikTok, LinkedIn, Programmatic, Audio, Gaming, Amazon) • Enhanced dual/single language processing")
